...
class CreateShapeFileDialog extends JDialog {
	...
	ActionListener lis = new ActionListener() {public void actionPerformed(ActionEvent ae) {
		...
		if (o == nameField) {
			...
			path = ((ShapefileFolder) (LocatorApplication.layer4.getLayerSource())).getPath();
	...
	//centerlabel;
	CreateShapeFileDialog (com.esri.mo2.map.dpy.FeatureLayer layer5) {
